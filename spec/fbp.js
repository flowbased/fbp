...
describe('FBP parser', () => {
  it('should provide a parse method', () => chai.expect(parser.parse).to.be.a('function'));
  describe('with simple FBP string', () => {
    ...
    describe('the generated graph', () => {
      it('should contain one node', () => chai.expect(graphData.processes).to.eql({
        Read: {
          component: 'ReadFile',
        },
      }));
  ...
  describe('with three-statement FBP string', () => {
    const fbpData = '\'somefile.txt\' -> SOURCE Read(ReadFile) OUT -> IN Display(Output)';
    let graphData = null;
    it('should produce a graph JSON object', () => {
      graphData = parser.parse(fbpData, {
        caseSensitive: true,
    ...
    describe('the generated graph', () => {
      it('should contain two nodes', () => chai.expect(graphData.processes).to.eql({
        Read: {
          component: 'ReadFile',
        },
        Display: {
  ...
  describe('with three-statement FBP string without instantiation', () => it('should not fail', () => {
    const fbpData = `'db' -> KEY SetDb(Set)
SplitDb(Split) OUT -> VALUE SetDb CONTEXT -> IN MergeContext(Merge)`;
  ...
  describe('with no spaces around arrows', () => it('should not fail', () => {
    const fbpData = 'a(A)->b(B) ->c(C)-> d(D)->e(E)';
    const graphData = parser.parse(fbpData, {
      caseSensitive: true,
    });
  ...
  describe('with anonymous nodes in an FBP string', () => {
    const fbpData = '(A) OUT -> IN (B) OUT -> IN (B)';
    let graphData = null;
    it('should produce a graph JSON object', () => {
      graphData = parser.parse(fbpData, {
        caseSensitive: true,
    ...
    describe('the generated graph', () => {
      it('should contain three nodes with unique names', () => chai.expect(graphData.processes).to.eql({
        _A_1: {
          component: 'A',
        },
        _B_1: {
      ...
      it('should contain two edges', () => chai.expect(graphData.connections).to.eql([
        {
          src: {
            process: '_A_1',
            port: 'OUT',
  ...
  describe('with default inport', () => {
    ...
    describe('the generated graph', () => {
      it('should default port name to "IN"', () => chai.expect(graphData.connections).to.eql([
        {
          src: {
            process: '_A_1',
            port: 'OUT',
  ...
  describe('with default outport', () => {
    ...
    describe('the generated graph', () => {
      it('should default port name to "OUT"', () => chai.expect(graphData.connections).to.eql([
        {
          src: {
            process: '_A_1',
            port: 'OUT',
  ...
  describe('with default ports', () => {
    ...
    describe('the generated graph', () => {
      it('should correctly use default ports', () => chai.expect(graphData.connections).to.eql([
        {
          src: {
            process: '_A_1',
            port: 'OUT',
...
GreetUser() DATA -> OPTIONS Render() OUT -> STRING WriteResponse()`;
    ...
    describe('the generated graph', () => {
      it('should contain eight nodes', () => {
        ...
        chai.expect(graphData.processes).to.have.keys(['WebServer', 'Profiler', 'Authentication', 'GreetUser', 'WriteResponse', 'Send', 'ReadTemplate', 'Render']);
      });
      it('should contain ten edges and IIPs', () => {
        chai.expect(graphData.connections).to.be.an('array');
        chai.expect(graphData.connections.length).to.equal(10);
      });
      it('should contain no exports', () => chai.expect(graphData.exports).to.be.an('undefined'));
    });
  });
  describe('with multiple arrayport connections on same line', () => {
    const fbpData = `'test 1' -> IN[0] Mux(mux) OUT[0] -> IN Display(console)
'test 2' -> IN[1] Mux OUT[1] -> IN Display`;
    ...
    describe('the generated graph', () => {
      it('should contain two nodes', () => chai.expect(graphData.processes).to.have.keys(['Mux', 'Display']));
      it('should contain two IIPs', () => {
        const iips = graphData.connections.filter((conn) => conn.data);
      ...
      it('should contain two regular connections', () => {
        const connections = graphData.connections.filter((conn) => conn.src);
  ...
  describe('with FBP string containing an IIP with whitespace', () => {
    ...
    describe('the generated graph', () => {
      it('should contain a node', () => chai.expect(graphData.processes).to.eql({
        Display: {
          component: 'Output',
        },
      }));
  ...
  describe('with FBP string containing a JSON IIP string', () => {
    const fbpData = '{ "string": "s", "number": 123, "array": [1,2,3], "object": {}} -> IN Display(Output)';
    let graphData = null;
    it('should produce a graph JSON object', () => {
      graphData = parser.parse(fbpData, {
        caseSensitive: true,
    ...
    describe('the generated graph', () => {
      ...
      it('should contain an IIP', () => {
        chai.expect(graphData.connections).to.be.an('array');
        chai.expect(graphData.connections.length).to.equal(1);
        chai.expect(graphData.connections[0].data).to.deep.equal({
          string: 's',
          number: 123,
          array: [1, 2, 3],
          object: {},
...
'foo bar' -> IN Display(Output) # Here we show the string`;
  ...
  describe('with FBP string containing URL as IIP', () => {
    const fbpData = '\'http://localhost:5984/default\' -> URL Conn(couchdb/OpenDatabase)';
    let graphData = null;
    it('should produce a graph JSON object', () => {
      graphData = parser.parse(fbpData, {
        caseSensitive: true,
  ...
  describe('with FBP string containing RegExp as IIP', () => {
    const fbpData = `'_id=(d+.d+.d*)=http://iks-project.eu/%deliverable/$1' -> REGEXP MapDeliverableUri(MapPropertyValue)
...
'Hi, {{ name }}' -> TEMPLATE Get`;
  ...
  describe('with FBP string with inports and outports', () => {
    const fbpData = `INPORT=Read.IN:FILENAME
...
Read(ReadFile) OUT -> IN Display(Output)`;
    ...
    describe('the generated graph', () => {
      ...
      it('should contain no legacy exports', () => chai.expect(graphData.exports).to.be.an('undefined'));
  ...
  describe('with FBP string with legacy EXPORTs', () => {
    const fbpData = `EXPORT=Read.IN:FILENAME
Read(ReadFile) OUT -> IN Display(Output)`;
    it('should fail', () => {
      chai.expect(() => parser.parse(fbpData, {
        caseSensitive: true,
      })).to.throw(Error);
    });
  });
  describe('with FBP string containing node metadata', () => {
    const fbpData = `Read(ReadFile) OUT -> IN Display(Output:foo=bar)
...
Display OUT -> IN Drop(Drop:foo=baz,baz=/foo/bar)`;
    ...
    it('should contain nodes with named routes', () => chai.expect(graphData.processes).to.eql({
      Read: {
        component: 'ReadFile',
      },
      Display: {
  ...
  describe('with FBP string containing node x/y metadata', () => {
    const fbpData = 'Read(ReadFile) OUT -> IN Display(Output:foo=bar,x=17,y=42)';
    let graphData = null;
    it('should produce a graph JSON object', () => {
      graphData = parser.parse(fbpData, {
        caseSensitive: true,
    ...
    it('should contain nodes with numerical x/y metadata', () => chai.expect(graphData.processes).to.eql({
      Read: {
        component: 'ReadFile',
      },
      Display: {
  ...
  describe('with commas to separate statements', () => {
    const fbpData = "'Hello' -> IN Foo(Component), 'World' -> IN Bar(OtherComponent), Foo OUT -> DATA Bar";
    let graphData = null;
    it('should produce a graph JSON object', () => {
      graphData = parser.parse(fbpData, {
        caseSensitive: true,
    ...
    describe('the generated graph', () => {
      ...
      it('should contain two IIPs and one edge', () => chai.expect(graphData.connections).to.eql([
        {
          data: 'Hello',
          tgt: {
            process: 'Foo',
  ...
  describe('with dashes and numbers in nodes, and components', () => {
    const fbpData = "'Hello 09' -> IN_2 Foo-Node-42(Component-15)";
    let graphData = null;
    it('should produce a graph JSON object', () => {
      graphData = parser.parse(fbpData, {
        caseSensitive: true,
  ...
  describe('with FBP string containing port indexes', () => {
    const fbpData = `Read(ReadFile) OUT[1] -> IN Display(Output:foo=bar)
...
Display OUT -> IN[0] Drop(Drop:foo=baz,baz=/foo/bar)`;
  ...
  describe('with case-sensitive FBP string', () => {
    const fbpData = "'Hello' -> in Foo(Component), 'World' -> inPut Bar(OtherComponent), Foo outPut -> data Bar";
    let graphData = null;
    it('should produce a graph JSON object', () => {
      graphData = parser.parse(fbpData, {
        caseSensitive: true,
...
DisplayIndexed OUT -> IN[0] Drop(Drop:foo=baz,baz=/foo/bar)`;
  ...
  describe('with FBP string with source node that doesn\'t have a component defined', () => {
    const fbpData = 'instanceMissingComponentName OUT -> (core/Output)';
    it('should fail', () => {
      chai.expect(() => parser.parse(fbpData, {
        caseSensitive: true,
  ...
  describe('with FBP string with IIP sent to node that doesn\'t have a component defined', () => {
    const fbpData = '\'localhost\' -> IN instanceMissingComponentName';
    it('should fail', () => {
      chai.expect(() => parser.parse(fbpData, {
        caseSensitive: true,
  ...
  describe('with FBP string with target node that doesn\'t have a component defined', () => {
    const fbpData = 'a(A)->b(B) ->c(C)-> d(D)->e';
    it('should fail', () => {
      chai.expect(() => parser.parse(fbpData, {
        caseSensitive: true,
  ...
  describe('with FBP string with exported inport pointing to non-existing node', () => {
    const fbpData = `INPORT=noexist.IN:broken
...
exist(foo/Bar)`;
  ...
  describe('with FBP string with exported outport pointing to non-existing node', () => {
    const fbpData = `INPORT=exist.IN:works
...
'somefile' -> SOURCE Read(ReadFile)`;
  ...
  describe('with FBP string containing a name annotation', () => {
    const fbpData = `# @name ReadSomefile
'somefile' -> SOURCE Read(ReadFile)`;
    let graphData = null;
    it('should produce a graph JSON object', () => {
      graphData = parser.parse(fbpData, {
    ...
    it('should contain the name', () => chai.expect(graphData.properties.name).to.equal('ReadSomefile'));
  });
...
'somefile' -> SOURCE Read(ReadFile)`;
    ...
    it('should contain the runtime type property', () => chai.expect(graphData.properties.environment.type).to.equal('foo'));
    it('should contain the name', () => chai.expect(graphData.properties.name).to.equal('ReadSomefile'));
  });
});
