module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c7 = /^[a-zA-Z.0-9_]/,
        peg$c8 = { type: "class", value: "[a-zA-Z.0-9_]", description: "[a-zA-Z.0-9_]" },
        peg$c9 = ":",
        peg$c10 = { type: "literal", value: ":", description: "\":\"" },
        peg$c11 = /^[a-zA-Z0-9_]/,
        peg$c12 = { type: "class", value: "[a-zA-Z0-9_]", description: "[a-zA-Z0-9_]" },
        peg$c13 = null,
        peg$c14 = function(priv, pub) {return parser.registerExports(makeName(priv),makeName(pub))},
        peg$c15 = "INPORT=",
        peg$c16 = { type: "literal", value: "INPORT=", description: "\"INPORT=\"" },
        peg$c17 = ".",
        peg$c18 = { type: "literal", value: ".", description: "\".\"" },
        peg$c19 = function(node, port, pub) {return parser.registerInports(makeName(node),makeName(port),makeName(pub))},
        peg$c20 = "OUTPORT=",
        peg$c21 = { type: "literal", value: "OUTPORT=", description: "\"OUTPORT=\"" },
        peg$c22 = function(node, port, pub) {return parser.registerOutports(makeName(node),makeName(port),makeName(pub))},
        peg$c23 = /^[\n\r\u2028\u2029]/,
        ...
        peg$c43 = function(node, comp) { if(comp){parser.addNode(makeName(node),comp);}; return makeName(node)},
        peg$c44 = "(",
        ...
        peg$c54 = function(portname) {return makeName(portname)},
        peg$c55 = "[",
        ...
        peg$c61 = function(portname, portindex) {return { port: makeName(portname), index: parseInt(portindex.join('')) }},
        peg$c62 = /^[^\n\r\u2028\u2029]/,
